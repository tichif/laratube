                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mt-3">
                                @if ($video->editable())
                                    <input type="text" name="title" id="title" value="{{ $video->title }}" style="border:none;outline:none">
                                @else
                                  {{ $video->title }}
                                @endif
                            </h4>
                      ...
                      <hr>
                        <div>
                          @if ($video->editable())
                            <textarea class="form-control" name="description" cols="3" rows="3" style="border:none;outline:none!important">{{ $video->description }}</textarea>

                            <div class="text-right">
                              <button type="submit" class="btn btn-primary mt-4 btn-sm">Update</button>
                            </div>
                          @else
                              {{ $video->description }}
                          @endif
